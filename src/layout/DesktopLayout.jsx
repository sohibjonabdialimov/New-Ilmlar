  ...
  return (
    <>
      <div className="sm:px-[1.6rem] px-[1rem] bg-layout_color min-h-[100dvh] pb-6">
        <Header />
        <div className="sm:px-6 px-3 bg-bg_color rounded-2xl mx-auto">{children}</div>
        ...
        <nav className="sm:hidden mobile_navbar fixed bottom-3 left-0 right-0 w-full bg-white z-50 rounded-3xl py-2">
          <div className="flex justify-around items-center px-8">
            ...
            <NavLink to={"/courses"} className="flex flex-col items-center gap-1 cursor-pointer">
            ...
            <NavLink to={"/student-profile"} className="flex flex-col items-center gap-1 cursor-pointer">
