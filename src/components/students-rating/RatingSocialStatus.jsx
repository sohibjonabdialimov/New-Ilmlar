...
const data = [
  { name: "Temir daftar", y: 6, z: 150, color: "#ff6b6b" },
  { name: "Ayollar daftari", y: 30, z: 150, color: "#ffe66d" },
  { name: "Yoshlar daftari", y: 25, z: 150, color: "#4dabf5" },
  { name: "Ijtimoiy himoya reestri", y: 13, z: 150, color: "#38c172" },
  { name: "Nogitonligi bor", y: 38, z: 150, color: "#9b59b6" },
  {
    name: "Chin yetim",
    y: 8,
    z: 150,
