...
const data = [
  { name: "ASOSIY SHTATDAGILAR", y: 25, z: 300, color: "#FF33A5FF" },
  { name: "O’RINDOSHLAR", y: 33, z: 300, color: "#FF8C33FF" },
];

VariablePie(Highcharts);
const TeacherPotensialDepart3 = () => {
  const options = {
    chart: {
      type: "variablepie",
      height: "40%"
...
export default TeacherPotensialDepart3;
