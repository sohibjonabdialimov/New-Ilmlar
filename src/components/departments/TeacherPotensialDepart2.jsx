...
const data = [
  { name: "ASOSIY SHTATDAGILAR", y: 21, z: 300, color: "#FF33A5FF" },
  { name: "O’RINDOSHLAR", y: 14, z: 300, color: "#FF8C33FF" },
];

VariablePie(Highcharts);
const TeacherPotensialDepart2 = () => {
  const options = {
    chart: {
      type: "variablepie",
      height: "40%"
...
export default TeacherPotensialDepart2;
