...
const data = [
  { name: "ASOSIY SHTATDAGILAR", y: 13, z: 300, color: "#FF33A5FF" },
  { name: "O’RINDOSHLAR", y: 10, z: 300, color: "#FF8C33FF" },
];

VariablePie(Highcharts);
const TeacherPotensialDepart4 = () => {
  const options = {
    chart: {
      type: "variablepie",
      height: "40%"
...
export default TeacherPotensialDepart4;
