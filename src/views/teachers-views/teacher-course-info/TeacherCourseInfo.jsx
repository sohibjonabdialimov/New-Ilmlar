    ...
    <div className="py-7 sm:mb-0 mb-16">
                ...
                >
                  <Accordion.Header className="accordion-header">
                    <Accordion.Trigger className="accordion-trigger">
                      ...
                      <button className="btn sm:text-base text-xs text-blue_color font-normal p-[4px_15px]">
                        Ko'rish
                      </button>
                      <button onClick={handeEditFunction} className="btn sm:text-base text-xs text-blue_color font-normal p-[4px_15px]">
                        Tahrirlash
                      </button>
      ...
      <div className="sm:hidden block mt-4 w-full h-[11rem]  shadow-[inset_0px_0px_5px_3px_#1D7AFCFF] p-5 rounded-[16px]">
          ...
          <div className="flex justify-center items-center pt-4 gap-2">
            ...
            <button onClick={() => navigate("/course-statistic")} className="w-full py-[10px] rounded-[100px] text-white bg-blue_color text-sm font-medium">
              Statistika
            </button>
            <button className="w-full py-[10px] rounded-[100px] text-white bg-blue_color text-sm font-medium">
              O'chirish
