  ...
  return (
    <div className="py-7">
      ...
      <div className="flex gap-8">
        <div className="flex-grow flex-shrink-0 basis-0 w-[70%]">
        ...
        <div className="course_prise_sticky sticky top-4 w-[30%] h-[13rem] shadow-[inset_0px_0px_5px_3px_#1D7AFCFF] p-5 rounded-[16px]">
